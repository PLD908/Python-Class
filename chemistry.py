...
# 1. Added a function to get the chemical formula name from a known dictionary.
# 2. Added a function to compute the total number of protons in the sample.
...
def main():
    ...
    # Get and print the formula name
